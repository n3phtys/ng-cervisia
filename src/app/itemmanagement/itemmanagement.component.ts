...
export class ItemmanagementComponent implements OnInit {
  ...
  createItem() {
    promptModal("Gib den Namen des neuen Getränks ein, oder lasse das Feld leer um abzubrechen. Du kannst den Namen später noch ändern. Das Getränk wird mit 1€ Preis und ohne Kategorie angelegt.", this.modal).forEach(c => {
