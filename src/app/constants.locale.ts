export const DonationProcessSuccess = "Getränke erfolgreich ausgegeben!";
export const DonationProcessFailure = "Ausgeben schlug fehl, kontrolliere bitte deine Eingaben auf Richtigkeit.";
